...
export class ListArtworksQueryDto {
  ...
  @ApiPropertyOptional({ description: 'Hex color or black/white/gray — filters by dominant palette hue' })
  @IsOptional()
  @IsString()
  color?: string;

  @ApiPropertyOptional({ description: 'Hue tolerance in degrees (default 35)' })
  @IsOptional()
