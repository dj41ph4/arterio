...
interface FiltersBarProps {
  ...
  onColorFilter: (v: string | null) => void;
  onClearFilters: () => void;
  viewMode: ViewMode;
...
export function FiltersBar({
  ...
  const hasFilters = statusFilter.length > 0 || collectionFilter.length > 0 || colorFilter !== null;
  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      ...
      <ColorFilter value={colorFilter} onChange={onColorFilter} />
      ...
      <div className="ml-auto flex items-center gap-2">
        ...
        {/* View toggle — hidden on mobile, where the gallery is forced (the table needs ~1700px) */}
