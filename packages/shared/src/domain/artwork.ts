...
export interface ArtworkQuery {
  ...
  yearTo?: number;
  favorite?: boolean;
  /** Hex color (e.g. "#8a3324") — matches artworks whose dominant palette contains a close hue. Special values "black"/"white"/"gray" match neutral palettes. */
  color?: string;
  /** Hue tolerance in degrees (default 35). */
  colorTol?: number;
